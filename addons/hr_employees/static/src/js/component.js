    ...
    class MyComponent extends Component {
        static template = xml`
            <div class="bg-info text-center p-2">
                <b> Welcome to Odoo </b>
                <i class="fa fa-arrow-left p-1" style="cursor:pointer;"
                ...
                <i class="fa fa-close p-1 float-right" style='cursor:pointer;'
        ...
        onNext(ev) { this.state.currentIndex++; }
        onPrevious(ev) { this.state.currentIndex-- }
    }
